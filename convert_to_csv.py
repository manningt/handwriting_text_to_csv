...
A reference for a starting point was https://github.com/manningt/email_invoices
The output should a CSV file with name,zip,email,visit-reason
'''
...
if __name__ == "__main__":
   ...
   if Path(csv_filename).is_file():
      sys.exit("{csv_filename} already exists.")
